	...
	<div id="layoutSidenav_content">
        ...
        <div class="container-fluid px-4">
           <h1 class="mt-4">영화 수정</h1>
			...
			<form action="MovieModifyPro.ad" name="fr" method="post" enctype="multipart/form-data" onsubmit="form_chk()">
			...
			<table style="border: 1;border-radius: 4px;">
				...
				<th style="text-align: center;height: 40">영화 정보</th>
				<tr><td>영화명</td>
					<td><label><input type="text" class="cssinput" name="movie_title" value="${movie.movie_title }" required="required"></label>
					</td></tr>
				<tr>
					<td>등급</td>
					<td>
				...
				<tr>
					<td>개봉일</td>
					<td>
						<label><input type="date" class="cssinput" name="movie_open_date" value="${movie.movie_open_date }" required="required"></label> 
					</td>
				</tr>
				<tr>
					<td>상영시간</td>
					<td>
						<label><input type="number" class="cssinput" name="movie_runtime" value="${movie.movie_runtime }" required="required"></label>
					</td>
				</tr>
				<tr>
					<td>줄거리</td>
					<td><textarea name="movie_intro" class="cssinput" cols="100" rows="10" required="required">${movie.movie_intro }</textarea></td>
				</tr>
				<tr>
					<td>등장인물</td>
					<td><textarea name="movie_actors" class="cssinput" cols="100" rows="3" required="required">${movie.movie_actors }</textarea></td>
				</tr>
				<tr>
					<td>영화 포스터</td>
					<td>
				...
				<tr>
					...
					<td>
						<label>
							...
							<input type="text" class="cssinput" name="movie_teaser" value="${movie.movie_teaser }" required="required" style="width:150px"/>
						</label>
					</td>
				</tr>
				<tr>
					<td>누적 관람객 수</td>
					<td><label><input type="number" class="cssinput" name="movie_viewer" value="${movie.movie_viewer }" required="required"></label></td>
				</tr>
				<tr>
					<td colspan="2">
