		...
		<div class="container">
			<div class="d-flex justify-content-between align-items-center">
				...
				<ol>
					...
					<li><a href="CouponList.ad">쿠폰 목록</a></li>
					<!-- 페이지 주소, 이름 넣는곳 -->
					<li><a href="CouponInsert.ad"></a>쿠폰 지급</li>
				</ol>
			</div>
		</div>
	</section>
			...
			<div class="container-fluid px-4">
				...
				<form action="CouponInsertPro.ad" name="fr" method="post">
					...
					<table border="1">
						...
						<tbody>
							<tr>
								<td><input type="text" name="coupon_type" required="required"></td>
								<td><input type="number" name="coupon_rate" required="required"></td>
